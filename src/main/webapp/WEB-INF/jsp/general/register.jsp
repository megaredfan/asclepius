...
<head>
  ...
  <%@ include file="../inc/include_javascript2.jsp" %>
  <%@ include file="../inc/include_css2.jsp" %>
...
<body>
  <div class="container_12">
    <div id="top">
      ...
      <div class="grid_6">
        <div class="welcome">
          Welcome visitor you can <a href="../login.html">登录</a> or <a href="register.html">注册</a>.
        </div><!-- .welcome -->
      </div><!-- .grid_6 -->
    ...
    <div class="container_12">      
       <div id="content">
		...
		<div class="grid_6 new_customers">
			...
			<div class="clear"></div>
            <form class="registed" id="signupForm" method="post" action="register.html">
            	<input type="hidden" name="opType" value="register" />
                <strong>用户名:</strong><sup class="surely">*</sup><br/>
                <input type="text" id="userName" name="userName" onblur="checkUserName($('#userName').val())"/><span id="restext"></span><br/>
                <div class="password">
			...
			<div style="color:red">
				<c:if test="${fieldErrors.size>0}">
					<c:forEach var="message" items="${fieldErrors}">
					<c:out value="${message}" />
				</c:forEach>
				</c:if>
			</div>
