...
<div class="content">
    <div class="service-section">
        <div class="container">
            ...
            <div class="service-grids">
                <div id="applist" class="service1">
                <c:forEach var="department" items="${departments}">
                <div class="col-md-4 service-grid">
                        <h5><c:out value="${department.departmentName}"/></h5>
                        <p>
                        	<c:if test="${fn:length(department.description)>100}">
                        		<c:out value="${fn:substring(department.description,0,99)}"/>...
                        	</c:if>
                        	<c:if test="${fn:length(department.description)<=100}">
 ...
 -->
    ...
    <ul class="pagination">
    	...
    	<li><a  onclick='toDepartmentPage(0)'>&lt;</a></li>
    		<c:if test="${totalPages!=1}">
    		<c:choose>
    			<c:when test="${pageNo<=4}">
    				<c:forEach var="i" begin="0" end="${pageNo}">
    					<li><a  onclick='toDepartmentPage(${i})'>${i+1}</a></li>
    				</c:forEach>
    			</c:when>
    			<c:otherwise>
    			 <li><a>...&nbsp;</a></li>
    		...
    		<c:choose>
    			...
    			<c:otherwise>
    				...
    				<li><a>...&nbsp;</a></li> 
    					<li><a  onclick='toDepartmentPage(${totalPages-1})'>${totalPages}</a></li>
    			</c:otherwise>
    		</c:choose>
    	</c:if>
    	<li><a  onclick='toDepartmentPage(${totalPages-1})'>&gt;</a></li>
    	</c:if>
    	<c:if test="${param.hospitalId!=null}">
    	<li><a  onclick='toDepartmentPageByhospital(${param.hospitalId},0)'>&lt;</a></li>
    		<c:if test="${totalPages!=1}">
    		<c:choose>
    			<c:when test="${pageNo<=4}">
    				<c:forEach var="i" begin="0" end="${pageNo}">
    					<li><a  onclick='toDepartmentPageByhospital(${param.hospitalId},${i})'>${i+1}</a></li>
    				</c:forEach>
    			</c:when>
    			<c:otherwise>
    			 <li><a>...&nbsp;</a></li> 
    		...
    		<c:choose>
    			...
    			<c:otherwise>
    				...
    				<li><a>...&nbsp;</a></li>  
    					<li><a  onclick='toDepartmentPageByhospital(${param.hospitalId},${totalPages-1})'>${totalPages}</a></li>
    			</c:otherwise>
    		</c:choose>
    	</c:if>
    	<li><a  onclick='toDepartmentPageByhospital(${param.hospitalId},${totalPages-1})'>&gt;</a></li>
    	</c:if>
